...
motivation: 现有的神经 PDE 求解器在处理耦合场时，难以准确捕捉局部高风险区域且无法有效保持物理结构的相容性。
method: 提出一种闭环框架，通过门控结构流形强制执行结构约束，并利用熵风险控制与后验认证驱动的测度传输动态调整训练重点。
result: 在多个二维耦合物理基准测试中，PICS 显著提升了跨场恢复的准确性与均衡性，同时兼顾了计算效率。
conclusion: 该研究为构建高可靠性、结构保全的多物理场仿真系统提供了一种严谨的信息几何求解方案。
---
